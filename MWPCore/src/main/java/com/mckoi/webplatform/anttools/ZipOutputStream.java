 ...
 *
 * <p>This class will try to use DataFile when you know that the
 * output is going to go to a file.</p>
 *
 * <p>If DataFile cannot be used, this implementation will use
...
public class ZipOutputStream extends FilterOutputStream {
   ...
   // CheckStyle:VisibilityModifier OFF - bc
     ...
     */
    public ZipOutputStream(DataFile file) throws IOException {
        super(null);
...
//            long save = raf.getFilePointer();
            long save = raf.position();

            raf.position(localDataStart);
