...
//    System.out.println("See LICENSE.txt for license details.");
//    System.out.println();
//
//    // Get configuration from a properties file,
//
//    if (args == null || args.length != 1) {
//      System.out.println(
//         "WebServiceNode is the Mckoi Web Platform service for HTTP and HTTPS");
//      System.out.println(
//         "services on the local server.");
//      System.out.println();
//      System.out.println("Command Line: WebServiceNode [configuration file]");
//      System.out.println();
//      System.out.println("The configuration file must contain the following properties:");
//      System.out.println();
//      System.out.println(" # General Settings");
//      System.out.println(" mwp_home=[path to base dir]");
//      System.out.println(" mckoi_client=[path to client.conf (default ./client.conf)]");
//      System.out.println(" mckoi_network=[path to network.conf (default ./network.conf) or URL]");
//      System.out.println(" security_policy=[security policy file (default ./security.policy) or URL]");
//      System.out.println(" allowed_classes=[allowed system classes file");
//      System.out.println("                        (default ./system_classes.policy) or URL]");
//      System.out.println(" temporary_dir=[path to temporary dir (default ./temp/)]");
//      System.out.println(" log_dir=[path to log dir (default ./log/)");
//      System.out.println();
//      System.out.println(" # For HTTP");
//      System.out.println(" http_active=true");
//      System.out.println(" http_port=[http port (default:80)]");
//      System.out.println(" http_address=[http ip address]");
//      System.out.println();
//      System.out.println(" # For HTTPS");
//      System.out.println(" https_active=true");
//      System.out.println(" https_port=[https port (default:443)]");
//      System.out.println(" https_address=[https ip address]");
//      System.out.println(" key_store_file=[path to keystore]");
//      System.out.println(" key_store_pwd=[key store password]");
//      System.out.println(" key_store_manager_pwd=[key store manager password]");
//      System.out.println();
//
//    }
//    else {
//
//      String config_location = args[0];
//      
//      Properties config = new Properties();
//      try {
//
//        // Parse config url string,
//        URL config_url;
//        try {
//          config_url = new URL(config_location);
//        }
//        catch (MalformedURLException e) {
//          config_url = new File(config_location).toURI().toURL();
//        }
//
//        // Report config location,
//        System.out.println("Loading configuration from: " + config_url);
//        System.out.println();
//
//        // Load the config,
//        URLConnection c = config_url.openConnection();
//        InputStream ins = c.getInputStream();
//        Reader r = new InputStreamReader(ins, "UTF-8");
//        config.load(r);
//
//        // Start the service with the given config,
//        WebServiceNode node = new WebServiceNode();
////        node.init(config);
////        node.start();
//
//      }
