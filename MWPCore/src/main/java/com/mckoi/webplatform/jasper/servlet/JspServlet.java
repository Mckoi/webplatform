...
public class JspServlet extends HttpServlet {
    ...
    // Logger
    private final transient Log log = LogFactory.getLog(org.apache.jasper.servlet.JspServlet.class);
...
//            serviceJspFile(request, response, jspUri, precompile);
            serviceJspFile(request, response, jspUri, false);
...
//            wrapper.service(request, response, precompile);
            ...
            out.println("Processing JSP file: " + jspUri + " (" + rctxt + ")");
