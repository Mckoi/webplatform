...
(function() {
  ...
  exports.process = function(ctx, vars, out) {
    ...
    try {
      ...
      out.println("download: " + e, "error");
      return STOP;
    }

    // If has the 'help' option,
    if (options.has('help')) {
      out.println(" download [from path]", "info");
      out.println();
    ...
    // Run client side script for download ui,
    out.runScript("js/cmdlineapps.js", "MWPDownload", qual_loc);
