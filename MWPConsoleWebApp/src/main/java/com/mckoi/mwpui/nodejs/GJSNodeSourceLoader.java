...
/**
 * This source loader is used to load native system modules.
 *
...
public class GJSNodeSourceLoader {
   ...
   *   against.
   */
  public GJSNodeSourceLoader(FileName library_path, FileName execution_path) {
   ...
   * @param library_path the path where library files are resolved against.
   */
  public GJSNodeSourceLoader(FileName library_path) {
    this.library_path = library_path;
   ...
   * @return 
   */
  public Object compileModule(String module_id, Object code) {
    return VMScriptCache.compileModule(
                                resolveFileName(module_id), code.toString());
  }
